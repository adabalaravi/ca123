 ...
 *       &lt;sequence>
 *         &lt;element name="ExternalOfferId" type="{http://accenture.avs.accountmgmt.commontypes}StrMin1Max50"/>
 *         &lt;element name="PackageId" type="{http://accenture.avs.accountmgmt.commontypes}StrMin1Max50"/>
...
public class ExternalOfferType {
    ...
    @XmlElement(name = "ExternalOfferId", required = true)
