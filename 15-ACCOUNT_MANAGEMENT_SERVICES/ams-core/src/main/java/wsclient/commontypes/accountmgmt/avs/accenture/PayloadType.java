 ...
 *         &lt;element name="UserStatus" type="{http://accenture.avs.accountmgmt.commontypes}Number2Digit"/>
 *         &lt;element name="CrmAccountDevices" type="{http://accenture.avs.accountmgmt.commontypes}CrmAccountDevicesListType"/>
 *         &lt;element name="Username" type="{http://accenture.avs.accountmgmt.commontypes}StrMin4Max32"/>
 *         &lt;element name="Password" type="{http://accenture.avs.accountmgmt.commontypes}StrMin4Max20"/>
 *         &lt;element name="Name" type="{http://accenture.avs.accountmgmt.commontypes}StrMin1Max256"/>
 *         &lt;element name="Surname" type="{http://accenture.avs.accountmgmt.commontypes}StrMin1Max256"/>
 *         &lt;element name="BirthDate" type="{http://accenture.avs.accountmgmt.commontypes}DateType"/>
 *         &lt;element name="Gender" type="{http://accenture.avs.accountmgmt.commontypes}FlagTypeMF"/>
 *         &lt;element name="CrmAccountZipCode" type="{http://accenture.avs.accountmgmt.commontypes}ZipCodeType"/>
 *         &lt;element name="Email" type="{http://accenture.avs.accountmgmt.commontypes}StrMin1Max100"/>
 *         &lt;element name="CrmAccountMobileNumber" type="{http://accenture.avs.accountmgmt.commontypes}StrMin1Max20"/>
 ...
 *         &lt;element name="CrmAccountConsumptionBlockingThresholdValue" type="{http://accenture.avs.accountmgmt.commontypes}Number5Digit"/>
 ...
 *         &lt;element name="CrmAccountConsumptionBlockingIntermediateThreshold" type="{http://accenture.avs.accountmgmt.commontypes}Number5Digit"/>
 ...
 *         &lt;element name="CrmAccountRetailerDomain" type="{http://accenture.avs.accountmgmt.commontypes}StrMin1Max50"/>
