...
public class UpdateUserService {
	...
	public AccountMgmtResponse updateUser() {
		...
		try {
			...
			LogUtil.writeCommonLog("INFO", UpdateUserService.class, "WS",
					"I'm in UpdateUserService.updateUser payload : " + updateUserRequest.toString());			
			crmAccountBean = AccountManagementDAO.getCrmAccountBean(
			...
			accountUserBean = AccountManagementDAO.getAccountUserBean(
					oldUserName, tenantName);
			...
			boolean result = AccountManagementDAO.updateUserData(
					crmAccountBean, accountUserBean, accountAttributes,
					tenantName);
	...
	private void updateUserData() {
		...
		if (userPcLevel != null) {
			updateAccountAttribute(
					AccountMgmtServiceConstant.ATTR_USER_PC_LEVEL_VOD,
					Integer.toString(userPcLevel));
			updateAccountAttribute(
					AccountMgmtServiceConstant.ATTR_USER_PC_LEVEL_EPG,
					Integer.toString(userPcLevel));
		}
		// NewPinPurchase
		...
		String userPcExtRat = "";
		UserPcExtendedRatingsListType listOfExtendRating = updateUserRequest
