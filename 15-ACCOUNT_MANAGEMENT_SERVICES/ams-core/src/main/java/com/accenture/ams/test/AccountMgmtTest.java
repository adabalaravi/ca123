...
import wsclient.commontypes.accountmgmt.avs.accenture.OperationProfileType;
...
//		testPayload.setChannel(channelPCTV);
//		testPayload.setCrmAccountDeviceIdType(5);
//		// Nel design c'� scritto che se l'utente non viene specificato,
//		// l'utente di default avr� un nome utente uguale al CrmAccountDeviceId;
//		testPayload.setUsername(userName);
//		testPayload.setPassword(password);
//		testPayload.setName(name);
//		testPayload.setSurname(surname);
...
//		assertTrue("Update error", dao.isCrmAccountIdPresent(crmAccountIdNew));
//		L'assert non andr� bene finch� in tabella saranno registrati pi� deviceId per lo stesso utente 
