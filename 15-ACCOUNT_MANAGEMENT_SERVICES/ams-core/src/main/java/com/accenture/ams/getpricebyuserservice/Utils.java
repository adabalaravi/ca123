...
import wsclient.types.getpricebyuser.avs.accenture.GetPriceByUserResponseData;
import wsclient.types.getpricebyuser.avs.accenture.GetPriceByUserResultData;
