...
public class AccountMgmtServiceConstant {
	...
	public static final int ATTR_USER_PC_LEVEL_VOD = 3;
	...
	public static final int ATTR_USER_PC_LEVEL_EPG = 47;
	...
	public static final String REFERENCE_TIMEZONE = "Brazil/West";
}
